...
//                       children: [
//                         Text('TOTAL', style: TextStyle(fontSize: 10, fontFamily: 'Roboto')),
//                         Text('Rp 1,429,000', style: TextStyle(fontSize: 16, fontFamily: 'Roboto', fontWeight: FontWeight.w700)),
//                       ],
//                     ),
//                   ),
//                 ),
...
//                     child: Text(
//                       'Add to Cart',
//                       style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, fontFamily: 'Roboto'),
//                     ),
//                     style: ElevatedButton.styleFrom(
