      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: (subtitle == null)
                  ? Text('$title', style: TextStyle(color: titleColor, fontFamily: 'Roboto', fontWeight: FontWeight.w500))
                  : Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('$title', style: TextStyle(color: AppColor.secondary, fontFamily: 'Roboto', fontWeight: FontWeight.w500)),
                        SizedBox(height: 2),
