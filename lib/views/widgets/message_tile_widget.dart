...
import 'package:marketky/core/models/Message.dart';
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text('${data.shopName}', style: TextStyle(color: AppColor.secondary, fontFamily: 'Roboto', fontWeight: FontWeight.w500)),
                  SizedBox(height: 2),
